function out = waveform_stack(w)
%WAVEFORM_STACK stacks data from array of waveforms
...
% MODIFICATION TO AVOID CONFLICT (stack ---> waveform_stack) BY ROBERT WALKER, 19 DEC 2013
